...
class SecurityUtilTest {
    ...
    private static final byte[] originalMessage = "This is a message to everyone out there! Please save the internet and Lahaina!"
            .getBytes();
    private static byte[] hmacKey;
    private static byte[] aesKey;
    private static byte[] expectedHMACBytes;
    private static byte[] expectedBytesAfterEncryption;
    private static byte[] expectedBytesAfterAddingHMAC;
    ...
    public static void setUp() {
        ...
        expectedBytesAfterEncryption = new byte[] {
                ...
                (byte) 0x00, (byte) 0x00,
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x8C, (byte) 0x25,
                (byte) 0xA2, (byte) 0x2B,
                (byte) 0x39, (byte) 0xE9, (byte) 0xFB, (byte) 0xFC, (byte) 0xEC, (byte) 0x2E, (byte) 0x5E, (byte) 0x68,
                (byte) 0x0D, (byte) 0xCD,
                (byte) 0x85, (byte) 0x9F, (byte) 0x96, (byte) 0x49, (byte) 0x9F, (byte) 0x78, (byte) 0x6A, (byte) 0x52,
                (byte) 0xFB, (byte) 0xD2,
                (byte) 0xFB, (byte) 0xB9, (byte) 0xDF, (byte) 0xDB, (byte) 0x72, (byte) 0x68, (byte) 0x24, (byte) 0x2B,
                (byte) 0x4C, (byte) 0xB4,
                (byte) 0x86, (byte) 0x7D, (byte) 0x6E, (byte) 0xCF, (byte) 0xD3, (byte) 0x5B, (byte) 0x8F, (byte) 0xF6,
                (byte) 0x33, (byte) 0xA4,
                (byte) 0xFA, (byte) 0x37, (byte) 0xA2, (byte) 0x97, (byte) 0xE4, (byte) 0x5F, (byte) 0x59, (byte) 0x5A,
                (byte) 0xF1, (byte) 0x4A,
                (byte) 0xBE, (byte) 0x7A, (byte) 0x74, (byte) 0x7A, (byte) 0xFB, (byte) 0x9E, (byte) 0x90, (byte) 0xF9,
                (byte) 0xFA, (byte) 0xE3,
        ...
        expectedBytesAfterAddingHMAC = new byte[] {
                (byte) 0x89, (byte) 0xDA, (byte) 0x9D, (byte) 0xC5, (byte) 0x25, (byte) 0xB5, (byte) 0x8D, (byte) 0x5B,
                (byte) 0xB2, (byte) 0x6B, (byte) 0x58, (byte) 0x29, (byte) 0xEE, (byte) 0x7E, (byte) 0x69, (byte) 0x20,
                (byte) 0xF9, (byte) 0x57, (byte) 0xE8, (byte) 0xE7, (byte) 0x16, (byte) 0x4A, (byte) 0xD2, (byte) 0x40,
                (byte) 0xC5, (byte) 0xCF, (byte) 0xAB, (byte) 0xEC, (byte) 0x22, (byte) 0xEB, (byte) 0xA8, (byte) 0x76,
    ...
    void encryptTest() {
        ...
        final byte[] actualBytes = SecurityUtil.encrypt(originalMessage, aesKey,
                randomProvider.getRandomBytes(IV_BLOCK_SIZE));
    ...
    void calculateHMACTest() {
        ...
        assertArrayEquals(expectedHMACBytes, actualBytes);
    }

    @Test
    void addHMACTest() {
        final byte[] actualBytes = SecurityUtil.addHMAC(expectedHMACBytes, expectedBytesAfterEncryption);
        assertArrayEquals(expectedBytesAfterAddingHMAC, actualBytes);
    }

    @Test
    void validateHMACTest() {
        final byte[] actualBytes = SecurityUtil.validateHMAC(expectedBytesAfterAddingHMAC, hmacKey);
        assertArrayEquals(expectedBytesAfterEncryption, actualBytes);
    }
