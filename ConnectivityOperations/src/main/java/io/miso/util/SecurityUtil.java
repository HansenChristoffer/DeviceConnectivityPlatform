...
public class SecurityUtil {
    ...
    public static byte[] encrypt(final byte[] data, final byte[] aesKey) {
        try {
            logger.debug("Outbound HMAC key: %s", Arrays.toString(aesKey));
    ...
    public static byte[] decrypt(final byte[] encryptedData, final byte[] aesKey) {
        try {
            logger.debug("Inbound HMAC key: %s", Arrays.toString(aesKey));
    ...
    public static byte[] calculateHMAC(final byte[] data, final byte[] hmacKey) {
        try {
            logger.debug("Outbound HMAC key: %s", Arrays.toString(hmacKey));
    ...
    public static byte[] validateHMAC(final byte[] dataWithHMAC, final byte[] hmacKey) {
        try {
            logger.debug("Inbound HMAC key: %s", Arrays.toString(hmacKey));
