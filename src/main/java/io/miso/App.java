 ...
 * TODO #1: Fix being able to build with maven
 * TODO #2: Incorporate build and testing in Github
 ...
 * TODO #5: Debug & fix RemoteMessageSMS. Tests says message is of length 64 but it is expected to be 124
 * TODO #6: Create RemoteMessage but for "over internet". (!) UDP
 * TODO #7: Project/Kanban board on Github (?)
